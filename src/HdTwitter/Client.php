...
use HdTwitter\Http\ClientInterface;
...
class Client implements ServiceManagerAwareInterface, EventManagerAwareInterface
{
    ...
    public function api($resource)
    {
        ...
        $service = $this->getServiceManager()->get('HdTwitter\Api\\' . $resource);
    ...
    public function getHttpClient()
    {
        if(null === $this->httpClient) {
           $this->httpClient = $this->getServiceManager()->get('HdTwitter\HttpClient');
           $errorListener = $this->getServiceManager()->get('HdTwitter\Listener\Error');
